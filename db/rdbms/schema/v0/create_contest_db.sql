...
CREATE TABLE targetmanager (
	id INT(6) UNSIGNED AUTO_INCREMENT PRIMARY KEY, 
	hostid VARCHAR(30) DEFAULT "" NOT NULL, 
	FQDN VARCHAR(50) DEFAULT "" NOT NULL, 
	IPv4 VARCHAR(30) DEFAULT "" NOT NULL, 
	IPv6 VARCHAR(40) DEFAULT "" NOT NULL, 
